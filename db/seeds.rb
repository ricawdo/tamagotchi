...
diane = Animal.new(name: 'Rox', breed: 'berger', age: 5, price: 67 ,description: 'Rox, un bon chien qui écoute quand on lui parle' ,specie:'Dog', adress: '16 villa gaudelet paris', user: user_bruno)
...
oneal = Animal.new(name: 'Oneal', breed: 'chaton', age: 2, price: 85 ,description: 'Oneal, un très beau chat' ,specie: 'Cat' ,adress: '16 avenue des champs elysées paris', user: user_ric)
oneal.photo.attach(io: URI.open(images[4]), filename: 'image')
oneal.save!

andrea = Animal.new(name: 'Andrea', breed: 'poule', age: 2, price: 5 ,description: 'Belle poule de déco' ,specie:'Chicken' ,adress: '10 rue de paris paris', user: user_bruno)
andrea.photo.attach(io: URI.open(images[12]), filename: 'image')
andrea.save!

benoit = Animal.new(name: 'Benoit', breed: 'pitbull', age: 2, price: 85 ,description: 'Benoit, un chien débile (mais drole)' ,specie:'Dog' ,adress: '5 rue de la paix paris', user: user_bruno)
...
maki = Animal.new(name: 'Maki', breed: 'chaton', age: 2, price: 85 ,description: 'Maki, beau chaton' ,specie: 'Cat' ,adress: '16 avenue des champs elysées paris', user: user_bruno)
maki.photo.attach(io: URI.open(images[3]), filename: 'image')
maki.save!

walter_white = Animal.new(name: 'Walter White', breed: 'chaton', age: 2, price: 99 ,description: 'Walter white, fabrique des bonbons bleu' ,specie: 'Cat' ,adress: '16 avenue des champs elysées paris', user: user_gwen)
walter_white.photo.attach(io: URI.open(images[7]), filename: 'image')
walter_white.save!

ken = Animal.new(name: 'Ken', breed: 'chaton', age: 2, price: 80 ,description: 'Ken, le bg' ,specie: 'Cat' ,adress: '16 avenue des champs elysées paris', user: user_bruno)
